...
stores_tbl      <- read_excel(path  = "~/GitHub/ss23-bdml-shubh11am/machine_learning_fundamentals/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Store Lookup",
                              skip  = 1)
products_tbl    <- read_excel(path  = "~/GitHub/ss23-bdml-shubh11am/machine_learning_fundamentals/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Products Lookup",
                              skip  = 1)
transaction_tbl <- read_excel(path  = "~/GitHub/ss23-bdml-shubh11am/machine_learning_fundamentals/breakfast_at_the_frat.xlsx",
