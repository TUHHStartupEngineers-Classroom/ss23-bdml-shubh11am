...
# Modeling ----------------------------------------------------------------
bike_orderlines_tbl <- readRDS("~/GitHub/ss23-bdml-shubh11am/machine_learning_fundamentals/bike_orderlines.rds")
...
bike_features_tbl <- readRDS("~/GitHub/ss23-bdml-shubh11am/machine_learning_fundamentals/bike_features_tbl.rds")
...
test_tbl <- filter(test_tbl, category_2 != "E-Road")

model_01_linear_lm_simple %>%
  predict(new_data = test_tbl)

# Run the model and make predictions
predictions <- model_01_linear_lm_simple %>%
  predict(new_data = test_tbl)
